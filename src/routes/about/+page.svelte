...
<PagesWrapper heading='About'>
  <aside class="w-full mb-6">
		<TableOfContents
			class="sticky top-12"
			active="text-[rgba(255,_49,_0,_1)]"
		/>
	</aside>
	<div
		id="scroll-container"
		class="w-full overflow-hidden text-token grid grid-cols-1"
		use:tocCrawler={{
			mode: 'generate',
			scrollTarget: '#page'
		}}
	>
		<h2 id="why-contribute-to-our-project?">Why Contribute to our Project?</h2>
		<p>
		...
		<h3 id="embrace-rust">Embrace Rust: a language of choice</h3>
		...
		<h3 id="prioritizing-code-quality">Prioritizing Code Quality</h3>
		...
		<h3 id="welcoming-community">A welcoming community for newcomers</h3>
		...
		<h3 id="influence-project">Influence the Project’s Future</h3>
		...
		<h3 id="join-today">Join us today</h3>
		...
		<h2 id="how-contribute">How to contribute?</h2>
		...
		<h2 id="knowledge-base">Torrent Knowledge Base</h2>
		...
		<h3 id="what-is-a-tracker">What Is a Tracker?</h3>
		...
		<h3 id="what-is-a-torrent-index">What Is a Torrent Index?</h3>
		...
		<h3 id="list-of-projects">List of projects using BitTorrent</h3>
